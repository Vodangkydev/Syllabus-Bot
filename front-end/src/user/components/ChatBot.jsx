...
function ChatBot() {
  ...
  const handleSendMessage = async (message) => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/chatbot/ask_stream?question=${encodeURIComponent(message)}`, {
        method: "GET",
        headers: {
  ...
  const saveEditMessage = async (index) => {
    ...
    try {
      const response = await fetch(`${API_URL}/chatbot/ask_stream?question=${encodeURIComponent(editingMessageContent)}&email=${encodeURIComponent(user?.email || "")}`, {
        method: "GET",
        headers: {
          "Content-Type": "text/event-stream",
          "Cache-Control": "no-cache",
